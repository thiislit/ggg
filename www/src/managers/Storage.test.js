...
describe('Storage Module', () => {
    ...
    describe('with Capacitor Preferences Backend', () => {
        ...
        it('should call Preferences.set', async () => {
            ...
            expect(global.Capacitor.Plugins.Preferences.set).toHaveBeenCalledWith({
                key: 'capKey',
                value: '{"a":1}',
            });
        ...
        it('should call Preferences.get', async () => {
            jest.mocked(global.Capacitor.Plugins.Preferences.get).mockResolvedValue({
                value: '{"a":1}',
            });
            const result = await Storage.get('capKey');
            expect(global.Capacitor.Plugins.Preferences.get).toHaveBeenCalledWith({
                key: 'capKey',
            });
        ...
        it('should call Preferences.remove', async () => {
            ...
            expect(global.Capacitor.Plugins.Preferences.remove).toHaveBeenCalledWith({
                key: 'capKey',
            });
        });
    ...
    describe('Error Handling', () => {
        ...
        it('should handle errors during set', async () => {
            ...
            expect(consoleErrorSpy).toHaveBeenCalledWith(
                '[Storage] Fallo al guardar circular:',
        ...
        it('should handle errors during remove', async () => {
            ...
            expect(consoleErrorSpy).toHaveBeenCalledWith(
                '[Storage] Fallo al eliminar anyKey:',
                expect.any(Error)
            );
        });
        ...
        it('should handle errors during clear', async () => {
            ...
            await Storage.clear();
            expect(consoleErrorSpy).toHaveBeenCalledWith(
                '[Storage] Fallo al limpiar almacenamiento:',
                expect.any(Error)
            );
        });
    });

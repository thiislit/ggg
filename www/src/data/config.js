export const CONFIG = {
    ...
    THEME: {
        ...
        get PRIMARY_STR() {
            return '#' + this.PRIMARY.toString(16).padStart(6, '0');
        },
        get SECONDARY_STR() {
            return '#' + this.SECONDARY.toString(16).padStart(6, '0');
        },
        get ACCENT_STR() {
            return '#' + this.ACCENT.toString(16).padStart(6, '0');
        },
        get BG_STR() {
            return '#' + this.BG.toString(16).padStart(6, '0');
        },
        ...
        get secondaryStr() {
            return this.SECONDARY_STR;
        },
        get accent() {
            return this.ACCENT;
        },
        get accentStr() {
            return this.ACCENT_STR;
        },
    },

    ...
    QUICK_PLAY_POOL: [
        {
            ...
            planet: { name: 'MARS', texture: ASSET_KEYS.SPRITESHEETS.PLANET_MARS, anim: ASSET_KEYS.ANIMATIONS.ANIM_MARS },
            stats: { health: 3 },
            dialogues: {
        ...
        },
        {
            ...
            planet: { name: 'KEPLER', texture: ASSET_KEYS.SPRITESHEETS.PLANET_KEPLER, anim: ASSET_KEYS.ANIMATIONS.ANIM_KEPLER },
            stats: { health: 3 },
            dialogues: {
                intro: "I SMELL FEAR!",
                win: "PREY CAPTURED!",
        ...
        },
        {
            ...
            planet: { name: 'NEBULA', texture: ASSET_KEYS.SPRITESHEETS.PLANET_NEBULA, anim: ASSET_KEYS.ANIMATIONS.ANIM_NEBULA },
            stats: { health: 3 },
            dialogues: {
        ...
        },
        {
            ...
            planet: { name: 'EARTH', texture: ASSET_KEYS.SPRITESHEETS.PLANET_TIERRA, anim: ASSET_KEYS.ANIMATIONS.ANIM_EARTH },
            stats: { health: 3 },
            dialogues: {

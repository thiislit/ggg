...
export class SettingsScene extends Phaser.Scene {
    ...
    async create() {
        ...
        // 1. Fondo bloqueador
        this.bg = this.add
            .rectangle(0, 0, width, height, colors.BG, 0.95)
            .setOrigin(0)
            .setInteractive();
        ...
        // 2. Título
        this.title = this.add
            .text(width / 2, height * 0.1, 'OPTIONS', {
        ...
        this.musicLabel = this.add
            .text(sliderX, height * 0.2, 'MUSIC VOLUME', {
                fontFamily: '"Press Start 2P"',
                fontSize: '12px',
                fill: colors.PRIMARY_STR,
            })
        ...
        this.sfxLabel = this.add
            .text(sliderX, height * 0.32, 'SFX VOLUME', {
                fontFamily: '"Press Start 2P"',
                fontSize: '12px',
                fill: colors.PRIMARY_STR,
            })
        ...
        this.add
            .text(width / 2 - 140, startY, 'MUTE GAME', {
                fontFamily: '"Press Start 2P"',
                fontSize: '14px',
                fill: colors.PRIMARY_STR,
            })
        ...
        // 5. Vibración
        this.vibrateSwitch = new Switch(
            this,
            width / 2,
            startY + rowStep,
            DataManager.isVibrateEnabled(),
            (newState) => {
        ...
        this.add
            .text(width / 2 - 140, startY + rowStep, 'VIBRATION', {
                fontFamily: '"Press Start 2P"',
                fontSize: '14px',
                fill: colors.PRIMARY_STR,
            })
        ...
        this.add
            .text(width / 2 - 140, startY + rowStep * 2, 'BG DIM', {
                fontFamily: '"Press Start 2P"',
                fontSize: '14px',
                fill: colors.PRIMARY_STR,
            })
        ...
        this.themeLabel = this.add
            .text(labelX, 0, 'BG THEME', {
                fontFamily: '"Press Start 2P"',
                fontSize: '14px',
                fill: colors.PRIMARY_STR,
            })
            .setOrigin(0, 0.5);
        this.themeValue = this.add
            .text(valueX + 40, 0, bgThemes[bgIdx].name, {
                fontFamily: '"Press Start 2P"',
                fontSize: '14px',
                fill: colors.PRIMARY_STR,
            })
        ...
        this.diffLabel = this.add
            .text(labelX, 0, 'DIFFICULTY', {
                fontFamily: '"Press Start 2P"',
                fontSize: '14px',
                fill: colors.PRIMARY_STR,
            })
            .setOrigin(0, 0.5);
        this.diffValue = this.add
            .text(valueX + 40, 0, this.difficulties[this.diffIdx], {
                fontFamily: '"Press Start 2P"',
                fontSize: '14px',
                fill: this.getDiffColor(this.difficulties[this.diffIdx]),
            })
            .setOrigin(0.5);
        const dL = this.add
            .text(valueX - 10, 0, '<', {
        ...
        this.add
            ...
            .setOrigin(0, 1)
            .setInteractive({ useHandCursor: true })
            .on('pointerdown', () => window.open('privacy.html', '_self'));

        this.add
            .text(width - 60, height - 30, 'CREDITS', {
                fontFamily: '"Press Start 2P"',
                fontSize: '10px',
                fill: '#666',
            })
            ...
            .on('pointerdown', () => {
                ...
                this.creditsText = this.add
                    .text(width / 2, height * 0.5, 'DEV: AXEL\nPHASER 3\nv1.1', {
                        fontFamily: '"Press Start 2P"',
                        fontSize: '12px',
                        fill: colors.ACCENT_STR,
                        align: 'center',
                        backgroundColor: colors.BG_STR,
                    })
                    .setOrigin(0.5)
                    .setDepth(100);

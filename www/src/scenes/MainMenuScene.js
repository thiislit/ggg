...
export class MainMenuScene extends Phaser.Scene {
    ...
    async create() {
        ...
        this.playerText = this.add.text(width / 2, height * 0.12, `HELLO, ${playerName}`, {
        ...
        // 2. QUICK PLAY
        const quickBtn = new RetroButton(this, width / 2, startY + gap, "QUICK PLAY", CONFIG.THEME.PRIMARY, () => {
        ...
        // 3. EDITAR PERFIL
        const profileBtn = new RetroButton(this, width / 2, startY + gap * 2, "EDIT PROFILE", CONFIG.THEME.ACCENT || 0x00FF00, () => {
            this.scene.start('ProfileScene');
        });
        this.menuButtons.push({ instance: profileBtn, type: 'SECONDARY' });

        // 4. OPCIONES
        const optBtn = new RetroButton(this, width / 2, startY + gap * 3, "OPTIONS", CONFIG.THEME.SECONDARY, () => {
        ...
        // --- VERSIÓN ---
        this.versionText = this.add.text(width - 20, height - 20, "v1.1", {
    ...
    startDevCampaign(level) {
        console.log(`[DEV] Starting Campaign Level ${level}`);
        CampaignManager.startCampaign();

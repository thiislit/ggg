...
export class GameOverScene extends Phaser.Scene {
    ...
    create(data) {
        ...
        let isWin =
            winner !== 'ZORG' &&
            winner !== 'OUTER RIM' &&
            winner !== 'ASTEROID BELT' &&
            winner !== 'ZORG BASE'; // Detectar si ganó el jugador
        ...
        this.add
            .text(width / 2, height * 0.25, titleText, {
                ...
                fontSize: '18px',
                fill: typeof color === 'number' ? '#' + color.toString(16) : color,
                align: 'center',
            })
            .setOrigin(0.5);
        ...
        const winText = this.add
            .text(width / 2, height * 0.35, mainText, {
                fontFamily: CONFIG.FONTS.MAIN,
                fontSize: fontSize,
                fill: typeof color === 'number' ? '#' + color.toString(16) : color,
                align: 'center',
        ...
        if (isCampaign) {
            ...
            if (isNewRecord) {
                const recText = this.add
                    .text(width / 2, infoY, 'NEW RECORD!', {
                        fontFamily: CONFIG.FONTS.MAIN,
                        fontSize: '22px',
                        fill: CONFIG.THEME.accentStr,
                    })
                    .setOrigin(0.5);
                this.tweens.add({
                    targets: recText,
                ...
                this.add
                    .text(width / 2, infoY + 40, `${streak} WINS IN A ROW`, {
                        fontFamily: CONFIG.FONTS.MAIN,
                ...
                this.add
                    .text(width / 2, infoY, `CURRENT STREAK: ${streak}`, {
                        fontFamily: CONFIG.FONTS.MAIN,
                        fontSize: '16px',
                        fill: CONFIG.THEME.secondaryStr,
                    })

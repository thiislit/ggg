...
export class EpilogueScene extends Phaser.Scene {
    ...
    create() {
        ...
        // 2. Personajes
        this.zorg = this.add
            .image(width / 2, height * 0.4, ASSET_KEYS.IMAGES.AVATAR_ZORG)
            .setScale(CONFIG.UI.EPILOGUE.ZORG_SCALE)
            .setAlpha(0);

        this.princessImages = {
            [ASSET_KEYS.IMAGES.STORY_PRINCESS_1]: this.add
                .image(width / 2, height * 0.4, ASSET_KEYS.IMAGES.STORY_PRINCESS_1)
                .setScale(CONFIG.UI.EPILOGUE.PRINCESS_SCALE)
                .setAlpha(0),
            [ASSET_KEYS.IMAGES.STORY_PRINCESS_2]: this.add
                .image(width / 2, height * 0.4, ASSET_KEYS.IMAGES.STORY_PRINCESS_2)
                .setScale(CONFIG.UI.EPILOGUE.PRINCESS_SCALE)
                .setAlpha(0),
            [ASSET_KEYS.IMAGES.STORY_PRINCESS_3]: this.add
                .image(width / 2, height * 0.4, ASSET_KEYS.IMAGES.STORY_PRINCESS_3)
                .setScale(CONFIG.UI.EPILOGUE.PRINCESS_SCALE)
                .setAlpha(0),
            [ASSET_KEYS.IMAGES.STORY_PRINCESS_4]: this.add
                .image(width / 2, height * 0.4, ASSET_KEYS.IMAGES.STORY_PRINCESS_4)
                .setScale(CONFIG.UI.EPILOGUE.PRINCESS_SCALE)
                .setAlpha(0),
        };
